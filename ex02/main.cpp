...
int main()
{
    ...
    trySignExecuteForm(new Bureaucrat("Bob", 145), new ShrubberyCreationForm("garden"));
    trySignExecuteForm(new Bureaucrat("Bob", 130), new ShrubberyCreationForm("garden"));
    trySignExecuteForm(new Bureaucrat("Doc Vi", 10), new PresidentialPardonForm(templPardon));
    trySignExecuteForm(new Bureaucrat("The President", 1), new PresidentialPardonForm(templPardon));
    trySignExecuteForm(new Bureaucrat(gardener), new RobotomyRequestForm("robotomytarget"));
    return 0;
}